...
;       March 2, 2014
;       April 5, 2014--changed RAM init. to use linker symbols
;       April 7, 2014--removed RAM init.
;       April 10, 2014--added ADC0, DAC0, SIM_SOPT2, and TMP2
;       April 14, 2014--added PIT
;***************************************************************
;EQUates
;Data sizes
...
ADC0_SC1A_OFFSET  EQU  0x00
ADC0_SC1B_OFFSET  EQU  0x04
ADC0_CFG1_OFFSET  EQU  0x08
ADC0_CFG2_OFFSET  EQU  0x0C
ADC0_RA_OFFSET    EQU  0x10
ADC0_RB_OFFSET    EQU  0x14
ADC0_CV1_OFFSET   EQU  0x18
ADC0_CV2_OFFSET   EQU  0x1C
ADC0_SC2_OFFSET   EQU  0x20
ADC0_SC3_OFFSET   EQU  0x24
ADC0_OFS_OFFSET   EQU  0x28
ADC0_PG_OFFSET    EQU  0x2C
ADC0_MG_OFFSET    EQU  0x30
ADC0_CLPD_OFFSET  EQU  0x34
ADC0_CLPS_OFFSET  EQU  0x38
ADC0_CLP4_OFFSET  EQU  0x3C
ADC0_CLP3_OFFSET  EQU  0x40
ADC0_CLP2_OFFSET  EQU  0x44
ADC0_CLP1_OFFSET  EQU  0x48
ADC0_CLP0_OFFSET  EQU  0x4C
ADC0_CLMD_OFFSET  EQU  0x54
ADC0_CLMS_OFFSET  EQU  0x58
ADC0_CLM4_OFFSET  EQU  0x5C
ADC0_CLM3_OFFSET  EQU  0x60
ADC0_CLM2_OFFSET  EQU  0x64
ADC0_CLM1_OFFSET  EQU  0x68
ADC0_CLM0_OFFSET  EQU  0x6C
ADC0_CFG1         EQU  ( ADC0_BASE + ADC0_CFG1_OFFSET)
ADC0_CFG2         EQU  ( ADC0_BASE + ADC0_CFG2_OFFSET)
ADC0_CLMD         EQU  ( ADC0_BASE + ADC0_CLMD_OFFSET)
ADC0_CLMS         EQU  ( ADC0_BASE + ADC0_CLMS_OFFSET)
ADC0_CLM0         EQU  ( ADC0_BASE + ADC0_CLM0_OFFSET)
ADC0_CLM1         EQU  ( ADC0_BASE + ADC0_CLM1_OFFSET)
ADC0_CLM2         EQU  ( ADC0_BASE + ADC0_CLM2_OFFSET)
ADC0_CLM3         EQU  ( ADC0_BASE + ADC0_CLM3_OFFSET)
ADC0_CLM4         EQU  ( ADC0_BASE + ADC0_CLM4_OFFSET)
ADC0_CLPD         EQU  ( ADC0_BASE + ADC0_CLPD_OFFSET)
ADC0_CLPS         EQU  ( ADC0_BASE + ADC0_CLPS_OFFSET)
ADC0_CLP0         EQU  ( ADC0_BASE + ADC0_CLP0_OFFSET)
ADC0_CLP1         EQU  ( ADC0_BASE + ADC0_CLP1_OFFSET)
ADC0_CLP2         EQU  ( ADC0_BASE + ADC0_CLP2_OFFSET)
ADC0_CLP3         EQU  ( ADC0_BASE + ADC0_CLP3_OFFSET)
ADC0_CLP4         EQU  ( ADC0_BASE + ADC0_CLP4_OFFSET)
ADC0_CV1          EQU  ( ADC0_BASE + ADC0_CV1_OFFSET)
ADC0_CV2          EQU  ( ADC0_BASE + ADC0_CV2_OFFSET)
ADC0_MG           EQU  ( ADC0_BASE + ADC0_MG_OFFSET) 
ADC0_OFS          EQU  ( ADC0_BASE + ADC0_OFS_OFFSET)
ADC0_PG           EQU  ( ADC0_BASE + ADC0_PG_OFFSET) 
ADC0_RA           EQU  ( ADC0_BASE + ADC0_RA_OFFSET)  
ADC0_RB           EQU  ( ADC0_BASE + ADC0_RB_OFFSET)  
ADC0_SC1A         EQU  ( ADC0_BASE + ADC0_SC1A_OFFSET)
ADC0_SC1B         EQU  ( ADC0_BASE + ADC0_SC1B_OFFSET)
ADC0_SC2          EQU  ( ADC0_BASE + ADC0_SC2_OFFSET)
ADC0_SC3          EQU  ( ADC0_BASE + ADC0_SC3_OFFSET)
;---------------------------------------------------------------
...
ADC_ADLPC_MASK   EQU  0x80
ADC_ADIV_MASK    EQU  0x60
ADC_ADLSMP_MASK  EQU  0x10
ADC_MODE_MASK    EQU  0x0C
ADC_ADICLK_MASK  EQU  0x03
;---------------------------------------------------------------
...
ADC_MUXSEL_MASK   EQU  0x10
ADC_ADACKEN_MASK  EQU  0x08
ADC_ADHSC_MASK    EQU  0x04
ADC_ADLSTS_MASK   EQU  0x03
;---------------------------------------------------------------
;ADC0_CLMD:  ADC0 minus-side general calibration value register D
;31-6:(reserved):read-only:0
; 5-0:CLMD=calibration value
ADC0_CLMD_MASK  EQU  0x3F
;---------------------------------------------------------------
;ADC0_CLMS:  ADC0 minus-side general calibration value register S
;31-6:(reserved):read-only:0
; 5-0:CLMS=calibration value
ADC0_CLMS_MASK  EQU  0x3F
;---------------------------------------------------------------
;ADC0_CLM0:  ADC0 minus-side general calibration value register 0
;31-6:(reserved):read-only:0
; 5-0:CLM0=calibration value
ADC0_CLM0_MASK  EQU  0x3F
;---------------------------------------------------------------
;ADC0_CLM1:  ADC0 minus-side general calibration value register 1
;31-7:(reserved):read-only:0
; 6-0:CLM1=calibration value
ADC0_CLM1_MASK  EQU  0x7F
;---------------------------------------------------------------
;ADC0_CLM2:  ADC0 minus-side general calibration value register 2
;31-8:(reserved):read-only:0
; 7-0:CLM2=calibration value
ADC0_CLM2_MASK  EQU  0xFF
;---------------------------------------------------------------
;ADC0_CLM3:  ADC0 minus-side general calibration value register 3
;31-9:(reserved):read-only:0
; 8-0:CLM3=calibration value
ADC0_CLM3_MASK  EQU  0x1FF
;---------------------------------------------------------------
;ADC0_CLM4:  ADC0 minus-side general calibration value register 4
;31-10:(reserved):read-only:0
; 9- 0:CLM4=calibration value
ADC0_CLM4_MASK  EQU  0x3FF
;---------------------------------------------------------------
;ADC0_CLPD:  ADC0 plus-side general calibration value register D
;31-6:(reserved):read-only:0
; 5-0:CLPD=calibration value
ADC0_CLPD_MASK  EQU  0x3F
;---------------------------------------------------------------
;ADC0_CLPS:  ADC0 plus-side general calibration value register S
;31-6:(reserved):read-only:0
; 5-0:CLPS=calibration value
ADC0_CLPS_MASK  EQU  0x3F
;---------------------------------------------------------------
;ADC0_CLP0:  ADC0 plus-side general calibration value register 0
;31-6:(reserved):read-only:0
; 5-0:CLP0=calibration value
ADC0_CLP0_MASK  EQU  0x3F
;---------------------------------------------------------------
;ADC0_CLP1:  ADC0 plus-side general calibration value register 1
;31-7:(reserved):read-only:0
; 6-0:CLP1=calibration value
ADC0_CLP1_MASK  EQU  0x7F
;---------------------------------------------------------------
;ADC0_CLP2:  ADC0 plus-side general calibration value register 2
;31-8:(reserved):read-only:0
; 7-0:CLP2=calibration value
ADC0_CLP2_MASK  EQU  0xFF
;---------------------------------------------------------------
;ADC0_CLP3:  ADC0 plus-side general calibration value register 3
;31-9:(reserved):read-only:0
; 8-0:CLP3=calibration value
ADC0_CLP3_MASK  EQU  0x1FF
;---------------------------------------------------------------
;ADC0_CLP4:  ADC0 plus-side general calibration value register 4
;31-10:(reserved):read-only:0
; 9- 0:CLP4=calibration value
ADC0_CLP4_MASK  EQU  0x3FF
;---------------------------------------------------------------
;ADC0_CVn:  ADC0 channel n compare value register
;CV1 used to compare result when ADC0_SC2.ACFE=1
;CV2 used to compare result when ADC0_SC2.ACREN=1
;31-16:(reserved):read-only:0
;15- 0:compare value (sign- or zero-extended if fewer than 16 bits)
ADC_CV_MASK  EQU  0xFFFF
;---------------------------------------------------------------
;ADC0_MG:  ADC0 minus-side gain register
;31-16:(reserved):read-only:0
;15- 0:MG=minus-side gain
ADC0_MG_MASK  EQU  0xFFFF
;---------------------------------------------------------------
;ADC0_OFS:  ADC0 offset correction register
;31-16:(reserved):read-only:0
;15- 0:OFS=offset error correction value
ADC0_OFS_MASK  EQU  0xFFFF
;---------------------------------------------------------------
;ADC0_PG:  ADC0 plus-side gain register
;31-16:(reserved):read-only:0
;15- 0:PG=plus-side gain
ADC0_PG_MASK  EQU  0xFFFF
;---------------------------------------------------------------
;ADC0_Rn:  ADC0 channel n data result register
;31-16:(reserved):read-only:0
;15- 0:data result (sign- or zero-extended if fewer than 16 bits)
ADC_D_MASK  EQU  0xFFFF
;---------------------------------------------------------------
;ADC0_SC1n:  ADC0 channel n status and control register 1
;31-8:(reserved):read-only:0
...
;           based on values in ADC0_CV1 and ADC0_CV2
...
;   3:ADCO=ADC continuous conversion enable (if ADC0_SC3.AVGE = 1)
...
;---------------------------------------------------------------
;DAC0_DAT0H:  DAC0 data high register 0
;If buffer not enabled, Vout = Vin * (1 + DATA[11:0])/4096.
;7-4:(reserved):read-only:0
;3-0:DATA1=DATA[7:0]
;---------------------------------------------------------------
;DAC0_DAT0L:  DAC0 data low register 0
;If buffer not enabled, Vout = Vin * (1 + DATA[11:0])/4096.
;7-0:DATA0=DATA[11:8]
;---------------------------------------------------------------
;DAC0_DAT1H:  DAC0 data high register 1
;If buffer not enabled, Vout = Vin * (1 + DATA[11:0])/4096.
;7-4:(reserved):read-only:0
;3-0:DATA1=DATA[7:0]
;---------------------------------------------------------------
;DAC0_DAT1L:  DAC0 data low register 1
;If buffer not enabled, Vout = Vin * (1 + DATA[11:0])/4096.
;7-0:DATA0=DATA[11:8]
;---------------------------------------------------------------
;DAC0_C0:  DAC0 control register 0
;7:DACEN=DAC enable
...
DAC0_DACEN_MASK      EQU  0x80
DAC0_DACRFS_MASK     EQU  0x40
DAC0_DACTRGSEL_MASK  EQU  0x20
DAC0_DACSWTRG_MASK   EQU  0x10
DAC0_LPEN_MASK       EQU  0x08
DAC0_DACBTIEN_MASK   EQU  0x02
DAC0_DACBBIEN_MASK   EQU  0x01
;---------------------------------------------------------------
;DAC0_C1:  DAC0 control register 1
...
DAC0_DMAEN_MASK      EQU  0x80
DAC0_DACBFMD_MASK    EQU  0x04
DAC0_DACBFEN_MASK    EQU  0x01
;---------------------------------------------------------------
;DAC0_C2:  DAC0 control register 2
;7-5:(reserved):read-only:0
;  4:DACBFRP=DAC buffer read pointer
;3-1:(reserved):read-only:0
;  0:DACBFUP=DAC buffer read upper limit
DAC0_DACBFRP_MASK  EQU  0x10
DAC0_DACBFUP_MASK  EQU  0x01
;---------------------------------------------------------------
;DAC0_SR:  DAC0 status register
...
DAC0_DACBFRPTF_MASK  EQU 0x02
DAC0_DACBFRPBF_MASK  EQU 0x01
;---------------------------------------------------------------
...
Reserved39_IPR   EQU   NVIC_IPR5  ;(reserved)
...
Reserved45_IPR   EQU   NVIC_IPR7  ;(reserved)
PORTA_IPR        EQU   NVIC_IPR7  ;PORTA pin detect
PORTD_IPR        EQU   NVIC_IPR7  ;PORTD pin detect
;---------------------------------------------------------------
;NVIC IPR position
...
Reserved39_PRI_POS   EQU   30  ;(reserved)
...
Reserved45_PRI_POS   EQU   14  ;(reserved)
PORTA_PRI_POS        EQU   22  ;PORTA pin detect
PORTD_PRI_POS        EQU   30  ;PORTD pin detect
;---------------------------------------------------------------
...
Reserved39_IRQ_MASK   EQU   (1 << Reserved39_IRQ )  ;(reserved)
...
Reserved45_IRQ_MASK   EQU   (1 << Reserved45_IRQ )  ;(reserved)
PORTA_IRQ_MASK        EQU   (1 << PORTA_IRQ      )  ;PORTA pin detect
PORTD_IRQ_MASK        EQU   (1 << PORTD_IRQ      )  ;PORTD pin detect
;---------------------------------------------------------------
;NVIC vectors
...
PIT_MDIS_MASK  EQU  0x00000002
PIT_FRZ_MASK   EQU  0x00000001
;---------------------------------------------------------------
...
;   0:TEN=timer enable
PIT_CHN_MASK  EQU  0x00000004
PIT_TIE_MASK  EQU  0x00000002
PIT_TEN_MASK  EQU  0x00000001
;---------------------------------------------------------------
;PIT_TFLGn:  timer flag register (channel n)
;31-1:(reserved):read-only:0
;   0:TIF=timer interrupt flag
;         write 1 to clear
PIT_TIF_MASK  EQU  0x00000001
;---------------------------------------------------------------
...
PIN_IRCQ_MASK          EQU  0x000F0000
PIN_MUX_MASK           EQU  0x00000700
PIN_DSE_MASK           EQU  0x40
PIN_PFE_MASK           EQU  0x10
PIN_SRE_MASK           EQU  0x04
PIN_PE_MASK            EQU  0x02
PIN_PS_MASK            EQU  0x01
...
TPM_CHF_MASK  EQU   0x80
TPM_CHIE_MASK  EQU  0x40
TPM_MSB_MASK   EQU  0x20
TPM_MSA_MASK   EQU  0x10
TPM_ELSB_MASK  EQU  0x08
TPM_ELSA_MASK  EQU  0x04
TPM_CDMA_MASK  EQU  0x01
;---------------------------------------------------------------
;TPMx_CnV:  Channel n Value
;31-16:(reserved):read-only:0
;16- 0:MOD (all bytes must be written at the same time)
TPM_CV_MASK    EQU 0xFFFF
;---------------------------------------------------------------
...
TPM_TRGSEL_MASK   EQU  0x0F000000
TPM_CROT_MASK     EQU  0x00040000
TPM_CSOO_MASK     EQU  0x00020000
TPM_CSOT_MASK     EQU  0x00010000
TPM_GTBEEN_MASK   EQU  0x200
TPM_DBGMODE_MASK  EQU  0xC0
TPM_DOZEEN_MASK   EQU  0x20
;---------------------------------------------------------------
;TPMx_MOD:  Modulo
;31-16:(reserved):read-only:0
;16- 0:MOD (all bytes must be written at the same time)
TPM_MOD_MASK    EQU 0xFFFF
;---------------------------------------------------------------
...
TPM_DMA_MASK    EQU 0x100
TPM_TOF_MASK    EQU 0x80
TPM_TOIE_MASK   EQU 0x40
TPM_CPWMS_MASK  EQU 0x20
TPM_CMOD_MASK   EQU 0x18
TPM_PS_MASK     EQU 0x07
;---------------------------------------------------------------
...
TPM_STATUS_TOF   EQU 0x100
TPM_STATUS_CH5F  EQU 0x20
TPM_STATUS_CH4F  EQU 0x10
TPM_STATUS_CH3F  EQU 0x08
TPM_STATUS_CH2F  EQU 0x04
TPM_STATUS_CH1F  EQU 0x02
TPM_STATUS_CH0F  EQU 0x01
;---------------------------------------------------------------
